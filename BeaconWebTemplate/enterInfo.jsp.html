        ...
        <div class="container body-wrap">
            ...
            <main class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <article>
                            <h2 class="article-title">Enter your information</h2>
                            ...
                            <label id="textArea">Keep this, or keep it simple? Anything else to share?</label><br />
                            <textarea name="friendShare" cols="30" rows="6" maxlength="1000" placeholder="Any additional info here"></textarea>
                            <p><input type="submit" value="Submit Info"> <input type="reset" value="Clear Info"></p>
                            </form>

                            <a href="gameSearch.jsp" class="btn btn-primary">Search for a game</a>
